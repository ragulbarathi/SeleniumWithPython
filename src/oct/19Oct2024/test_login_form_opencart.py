...
def test_verify_register_account():
    ...
    driver.find_element(by=By.ID, value="input-email").send_keys("ragulravibarathi@gmail.com")
    driver.find_element(by=By.ID, value="input-telephone").send_keys("04132964832")
